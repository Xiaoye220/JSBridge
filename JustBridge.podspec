...
Pod::Spec.new do |s|
  s.name             = 'JustBridge'
  s.version          = '4.2.0'
  s.summary          = 'An iOS bridge for sending messages between Swift and JavaScript in WKWebView.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/Xiaoye220/JSBridge'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Xiaoye220' => '576934532@qq.com' }
  s.source           = { :git => 'https://github.com/Xiaoye220/JSBridge.git', :tag => s.version.to_s }
